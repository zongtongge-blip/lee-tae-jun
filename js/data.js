...
const SITES = [
  ...
  /* ---------------------------- 만리장성 ---------------------------- */
  {
    ...
    image: "",
    desc: {
      ko: "만리장성은 중국 북부에 세워진 거대한 성벽으로, 춘추전국시대부터 명나라 시대까지 오랜 세월에 걸쳐 축조되었습니다. 북방 유목민족의 침입을 막기 위한 방어 시설이었으며, 총 길이는 2만 km가 넘습니다. 오늘날에는 중국을 대표하는 세계문화유산이자 인기 관광지로, 베이징 근교의 바다링(八达岭) 구간이 특히 유명합니다.",
